...
| 最新安装包 | 系统 | 架构 |
| --- | --- | --- |
| [line puppy 最新版](https://github.com/remake1026/desktop-pets/releases/latest/download/line.puppy-2.0.0-Win10-11-Setup.exe)（约 182 MB） | Windows 10、Windows 11 | 自动选择 x86 / x64 |
